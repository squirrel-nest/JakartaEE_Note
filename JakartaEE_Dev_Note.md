...
to check if you don't have multiple SLF4J implementations, check the standard error.</pre>
        ...
        <li>
            <details open>
                <summary>
                    <i><b>✨ Maven Dependency and Plugin 版本 的 管理 与 更新</b></i>
                </summary>
                <ul type="disc">
                    <li>
                        参考：<a href="https://github.com/huarui0/Android_Note/blob/master/Android_Note.md#query-gradle-dependency-and-plugin-version-resource">huarui0/Android_Note/Android_Note.md 中 「所有 Maven Dependency and Plugin 版本 更新 信息 汇总 都是在这里 查」 部分</a>
                    </li>
                    <li>
                        <details open>
                            <summary>
                                <i><b>✨ 更新 资源 笔记 都 迁移到 <a href="../../../../BuildTool_Note/blob/master/12_Gradle_Usage_Note.md#gradle-dependency-and-plugin-version-upgrade-source">这里</a></b></i>
                            </summary>
                            <ul type="disc">
                                <li>
